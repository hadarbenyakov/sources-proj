...
export default function RequestSent() {
  ...
  return (
    <div
      className="w-[393px] h-[852px] relative overflow-hidden select-none cursor-pointer"
    ...
    >
      ...
      <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 flex flex-col items-center px-[40px]">
        {/* Check circle */}
        <div className="w-[88px] h-[88px] rounded-full bg-black flex items-center justify-center">
          <CheckIcon size={36} className="text-white" />
        </div>

        {/* Title */}
        <p className="text-[17px] font-medium text-black text-center leading-[1.4] mt-[28px] max-w-[260px]">
        ...
        <button
          type="button"
          onClick={edit}
          className="text-[14px] text-black underline underline-offset-2 mt-[28px]"
        >
          edit
        </button>
      </div>
      ...
      {/* Tap-to-close hint */}
      <p className="absolute left-0 right-0 bottom-[36px] text-center text-[12px] text-black/55">
